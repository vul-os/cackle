...
export const PrintTicketButtons = ({ ticketId, onPrint, isPrinting }) => {
    return (
        <div className="mt-4 flex flex-wrap gap-2 print:hidden">
            <Button onClick={onPrint} variant="outline" size="sm" className={TAP_BUTTON_SM} disabled={isPrinting}>
...
export const PrintAllButton = ({ onPrintAll, isPrinting, ticketsCount }) => {
    ...
    return (
        <Button onClick={onPrintAll} variant="outline" size="sm" className={`print:hidden ${TAP_BUTTON_SM}`} disabled={isPrinting}>
