...
import { decideAdmission, describeError, RESULT } from './scan-decision.js';
import { verifyWithRing } from './capability.js';
...
function mintTicket({
    ...
    const payload = { v: 1, tid, eid, nm, iat, exp, kid };
