 ...
 * @returns {string} block body, without the outer braces
 */
 ...
 *
 * @param {string} css contents of src/index.css
 ...
 * @param {string} name with or without the leading `--`
 * @returns {string}
 */
export function token(scope, name) {
