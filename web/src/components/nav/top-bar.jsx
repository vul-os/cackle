...
const TopBar = ({ onMenuClick }) => {
    ...
    return (
        <nav className="fixed left-0 right-0 top-0 z-50 flex h-16 items-center justify-between border-b border-white/10 bg-zinc-950 px-4 text-white sm:px-6">
            <div className="flex items-center gap-3">
                ...
                <Link to="/" className="flex items-center gap-2">
                    ...
                    <span className="hidden font-display text-2xl font-black tracking-tight text-white sm:block">cackle</span>
                </Link>
            </div>
